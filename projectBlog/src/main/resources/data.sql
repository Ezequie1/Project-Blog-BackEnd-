...
INSERT INTO post (title, text, favorite, data_post) VALUES
        ('Apple lança novo iPhone 15', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vestibulum auctor est. Nam vitae finibus ante.', false, '2024-06-01'),
        ...
        ('Meta revela novas ferramentas para o metaverso', 'Praesent et auctor justo. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', false, '2024-05-28'),
        ...
        ('SpaceX realiza lançamento histórico com foguete reutilizável', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vestibulum auctor est.', false, '2023-03-22'),
        ...
        ('Amazon expande serviços de entrega com drones', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et auctor justo.', true, '2024-05-30'),
        ('Samsung revela nova linha de TVs 8K', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae finibus ante.', false, '2024-04-06'),
        ...
        ('Uber testa táxis autônomos em São Francisco', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Vestibulum vestibulum auctor est. Praesent et auctor justo.', true, '2023-02-12'),
        ('Sony lança novo console PlayStation 6', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae finibus ante. Duis lobortis tellus vel diam fringilla.', true, '2024-03-09'),
        ...
        ('TikTok adiciona funcionalidades para criadores de conteúdo', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae finibus ante.', false, '2024-02-27'),
        ('NVIDIA anuncia nova linha de GPUs para gamers', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Duis lobortis tellus vel diam fringilla.', true, '2024-06-02'),
        ('Reddit lança novo design para sua plataforma', 'Vestibulum vestibulum auctor est. Lorem ipsum dolor sit amet, consectetur adipiscing elit.', false, '2024-01-31'),
        ...
        ('Spotify introduz novos recursos de personalização de playlists', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Praesent et auctor justo. Nam vitae finibus ante.', false, '2024-04-18'),
        ...
        ('Oracle apresenta novas soluções de banco de dados na nuvem', 'Lorem ipsum dolor sit amet, consectetur adipiscing elit. Nam vitae finibus ante.', true, '2024-02-20'),
